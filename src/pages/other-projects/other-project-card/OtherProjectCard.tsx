...
export const OtherProjectCard: FC<Props> = ({ id, title, github, tags, description, readMore, image, jpg }) => {
    return (
        <Flex
        ...
        >
            <Box flex="0.25" display={{ base: "none", md: "block" }} data-aos="fade-up" data-aos-offset="200">
                <picture>
                    ...
                    <Image ignoreFallback src={image} borderRadius="xl" alt={`${title}-cover-image`} loading="lazy" decoding="async" />
                </picture>
            </Box>
