...
interface Props extends GitHubButtonProps, ReadMoreProps, LiveDemoProps, ReportButtonProps {}
...
export const ReportButton: FC<ReportButtonProps> = ({ report, display }) => {
    const as = useBreakpointValue({ base: IconButton, lg: Button }) ?? Button;
...
export const ProjectCardFooter: FC<Props> = ({ readMore, github, demo, report }) => {
    return (
        <Flex justifyContent={readMore ? "space-between" : "flex-end"} alignItems="center" pt="8">
            <ReadMore readMore={readMore} />
            <Flex gap="4" justifyContent="space-between" alignItems="center" display={report || github ? "flex" : "none"}>
